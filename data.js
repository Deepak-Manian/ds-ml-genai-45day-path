const SECTIONS = [
  ...
  },
  {
    ...
    skills: [
      ...
      { id:"dl_08", name:"Transformers — attention, multi-head attention, positional encoding, encoder/decoder", desc:"The architecture behind virtually everything in 2024–2026", tag:"hot", resources:[{name:"Illustrated Transformer — Jay Alammar (free)",platform:"jalammar.github.io",url:"https://jalammar.github.io/illustrated-transformer/",icon:"BL"},{name:"Attention is All You Need (free paper)",platform:"arxiv.org",url:"https://arxiv.org/abs/1706.03762",icon:"AR"}]},
  ...
  },
  {
    ...
    skills: [
      ...
      { id:"nlp_04", name:"BERT & variants — tokenisation, CLS token, fine-tuning for classification/NER", desc:"Industry-standard NLP backbone for 2024–2026", tag:"hot", resources:[{name:"HuggingFace Course (free)",platform:"huggingface.co",url:"https://huggingface.co/learn/nlp-course/chapter1/1",icon:"HF"}]},
  ...
  },
  {
    ...
    skills: [
      ...
      { id:"ga_03", name:"RAG — Retrieval Augmented Generation, chunking strategies, reranking, hybrid search", desc:"The most deployed LLM pattern in production in 2024–2026", tag:"hot", resources:[{name:"LangChain RAG Tutorial (free)",platform:"python.langchain.com",url:"https://python.langchain.com/docs/tutorials/rag/",icon:"LC"}]},
